...
export function Logo({ size = "md", showText = true }: LogoProps) {
  ...
  return (
    <Link href="/dashboard" className="flex items-center gap-2.5 group">
      <div
        className={`${s.box} flex items-center justify-center rounded-lg bg-gradient-to-br from-[#2997ff] to-[#0066cc] text-white shadow-lg shadow-blue-500/20 transition-transform duration-300 group-hover:scale-105`}
      >
        <svg
          className={s.icon}
          viewBox="0 0 24 24"
