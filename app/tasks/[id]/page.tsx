      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-2">
            <Badge className={`capitalize ${priorityColor(task.priority)}`}>
              {task.priority}
            </Badge>
          ...
          <CardContent className="pt-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select value={status} onValueChange={setStatus}>
                  ...
                  <SelectContent>
                    {["open", "in_progress", "completed", "cancelled"].map(
                      (s) => (
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Notes on findings, conclusions, next steps..."
              />
            </div>
            <Button onClick={handleUpdate} disabled={updating}>
              {updating ? (
                ...
                <>
                  <CheckCircle className="mr-1 h-4 w-4" /> Update Task
                </>
              )}
            </Button>
          </CardContent>
        ...
        {data.evidence.length > 0 && (
          <div>
            <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
              <FileText className="h-4 w-4" /> Linked Evidence
            </h3>
            <div className="space-y-2">
        ...
        {data.entities.length > 0 && (
          <div>
            <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
              <Users className="h-4 w-4" /> Linked Entities
            </h3>
